...
// Advance overwrites the frontier with the supplied timestamp and publishes
// it immediately. A regressive advance is accepted, so the watermark can move
// backwards after a window already fired.
